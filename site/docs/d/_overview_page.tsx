...
/**
 * The We The Citizens D front door — WeCitizensD.com.
 *
 ...
 * no symmetry rule: D is Democrat, and what belongs on this page is decided by
 * marketing/messaging/democrats.md alone. Editing it changes this door and nothing else, which is the
...
const DOMAIN = 'WeCitizensD.com';
const URL = 'https://wecitizensd.com';
...
export default function WeTheCitizensDOverview(): ReactNode {
  return (
        ...
        <div className={styles.heroInner}>
          <div className={styles.heroGrid}>
            <div className={styles.heroCopy}>
              <h1 className={styles.heroDisplay}>We The<br />Citizens D</h1>
          ...
          <div className={styles.heroBelow}>
            <p className={styles.heroLede}>
              The Democrat front door onto We The Citizens. It asks you for nothing up front and shows you one thing: your own seats, the people holding them right now, what they actually voted for, and who could replace them.
            </p>
          ...
          <div className={styles.editorialGrid}>
            <div className={styles.editorialAside}>
              <div className={styles.editorialStick}>
                <span className={styles.eyebrow}>Why a Democrat front door exists</span>
                <h2 className={styles.sectionTitle} style={{marginTop: '1.2rem'}}>
                  I am a Democrat. Is this site for me?
                </h2>
              </div>
            </div>
            <div className={styles.editorialBody}>
              <p className={styles.dropcap}>
                Yes. This is the room where Democrat voters do the work. The center of this door is economics: this community building its own package for removing the rigged layer and getting back to an economy that is ethical, clean and ideal for workers.
              </p>
              <p>
              ...
              <p>
                Cross-party persuasion is expensive and slow. In-party accountability is cheap and fast, because you already agree with the party label and only have to be shown that this particular officeholder is voting with their donors instead of their constituents. Holding your own side to its own stated standard is the highest-leverage act available to a voter.
              </p>
              <div className={styles.dateStamp}>{DOMAIN} · The Democrat edition</div>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className={styles.wrap}>
          ...
          <div className={styles.planGrid}>
            ...
            <article className={styles.planCard}>
              ...
              <p>
                The leading challenger on your own side — a primary challenger when the incumbent is also a Democrat — with
          ...
          <div className={styles.planCta}>
            <p className={styles.planCtaText}>
              An empty column stays a column. You get an honest "no vetted Democrat{' '}
      ...
      <section className={clsx(styles.section, styles.bgPanel)} id="stands">
        <div className={styles.wrap}>
          <div className={clsx(styles.sectionHead, styles.sectionHeadSplit)}>
            ...
            <p className={styles.sectionLead}>
              Written by Democrat voters, in their own language, on this door and nowhere else. The .io stays neutral; everything partisan lives here.
            </p>
          </div>
        ...
        <div className={styles.wrap}>
          ...
          <div className={styles.programs}>
            <article className={styles.program}>
              ...
              <p>
                The Democrat front door at {DOMAIN}. Written for Democrats, from
                marketing/messaging/democrats.md.
              </p>
              <div className={styles.pTag}>Democrats · {DOMAIN}</div>
            </article>
