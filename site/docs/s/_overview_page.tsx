 ...
 * no symmetry rule: S is Democratic Socialist, and what belongs on this page is decided by
 * marketing/messaging/socialism.md alone. Editing it changes this door and nothing else, which is the
...
const DOMAIN = 'WeCitizensSocialism.com';
const URL = 'https://wecitizenssocialism.com';
...
const OTHER_DOORS: {code: string; key: string; audience: string; domain: string}[] = [
  ...
  {code: 'L', key: 'l', audience: 'Libertarians', domain: 'WeCitizensL.com'},
];
        ...
        <div className={styles.heroInner}>
          <div className={styles.heroGrid}>
            <div className={styles.heroCopy}>
              <h1 className={styles.heroDisplay}>We The<br />Citizens S</h1>
          ...
          <div className={styles.heroBelow}>
            <p className={styles.heroLede}>
              The Democratic Socialist front door onto We The Citizens. It asks you for nothing up front and shows you one thing: your own seats, the people holding them right now, what they actually voted for, and who could replace them.
            </p>
          ...
          <div className={styles.editorialGrid}>
            <div className={styles.editorialAside}>
              <div className={styles.editorialStick}>
                <span className={styles.eyebrow}>Why a Democratic Socialist front door exists</span>
            ...
            <div className={styles.editorialBody}>
              <p className={styles.dropcap}>
                Yes. This is the room where democratic socialists do the work — and this community is addressed as democratic socialists, never as “socialists”. The center of this door is economics: building this community's own package for removing the rigged layer and getting to an economy that is ethical and ideal for workers.
              </p>
              <p>
              ...
              <p>
                Merit here is judged on the basis this community chooses for itself. The test for an officeholder is whether their votes track special interests or the people who elected them — and that is a question the roll-call record answers, not a slogan.
              </p>
              <div className={styles.dateStamp}>{DOMAIN} · The Democratic Socialist edition</div>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className={styles.wrap}>
          ...
          <div className={styles.planGrid}>
            ...
            <article className={styles.planCard}>
              ...
              <h3>Democratic Socialist challenger</h3>
              <p>
                The leading challenger on your own side — a primary challenger when the incumbent also runs with this community's support — with
          ...
          <div className={styles.planCta}>
            <p className={styles.planCtaText}>
              An empty column stays a column. You get an honest "no vetted Democratic Socialist{' '}
      ...
      <section className={clsx(styles.section, styles.bgPanel)} id="stands">
        <div className={styles.wrap}>
          <div className={clsx(styles.sectionHead, styles.sectionHeadSplit)}>
            ...
            <p className={styles.sectionLead}>
              Written by democratic socialists, in this community's own language, on this door and nowhere else. The .io stays neutral; everything partisan lives here.
            </p>
          </div>
          ...
          <div className={styles.articles}>
            <article className={styles.article}>
              ...
              <div className={styles.artBody}>
                <h3><Link to="/s/replace_incumbents">Challengers not controlled by special interests</Link></h3>
                <p>
            ...
            <article className={styles.article}>
              ...
              <div className={styles.artBody}>
                <h3><Link to="/s/meritocracy">Merit on this community's own basis</Link></h3>
                <p>
                  The same engine as every other door, run on the criteria democratic socialists choose for themselves — published, open, and re-runnable by anyone.
                </p>
              </div>
            </article>
            <article className={styles.article}>
              ...
              <div className={styles.artBody}>
                <h3><Link to="/s/economics_for_workers">Economics that work for workers</Link></h3>
                <p>
            ...
            <article className={styles.article}>
              ...
              <div className={styles.artBody}>
                <h3><Link to="/s/ai_era_economy">An economy ideal for workers in the era of AI</Link></h3>
                <p>
            ...
            <article className={styles.article}>
              ...
              <div className={styles.artBody}>
                <h3><Link to="/s/new_colonialism">Ending the new colonialism</Link></h3>
                <p>
            ...
            <article className={styles.article}>
              ...
              <div className={styles.artBody}>
                <h3><Link to="/s/rigged_economy">The Democratic Socialist rigged-economy package</Link></h3>
                <p>
          ...
          <div className={styles.planCta}>
            ...
            <Link className={clsx(styles.btn, styles.btnPrimary)} to="/s/words_we_use">
        ...
        <div className={styles.wrap}>
          ...
          <div className={styles.programs}>
            <article className={styles.program}>
              ...
              <h3>We The Citizens S</h3>
              <p>
                The Democratic Socialist front door at {DOMAIN}. Written for Democratic Socialists, from
                marketing/messaging/socialism.md.
              </p>
              <div className={styles.pTag}>Democratic Socialists · {DOMAIN}</div>
            </article>
        ...
        <div className={styles.wrap}>
          ...
          <div className={styles.govGrid}>
            <div className={styles.govItem}>
              ...
              <h3>
                <Link to="/s/words_we_use">Words we use and words we avoid</Link>
              </h3>
