 ...
 * no symmetry rule: R is Republican, and what belongs on this page is decided by
 * marketing/messaging/republicans.md alone. Editing it changes this door and nothing else, which is the
...
const DOMAIN = 'WeCitizensR.com';
const URL = 'https://wecitizensr.com';
        ...
        <div className={styles.heroInner}>
          ...
          <div className={styles.heroBelow}>
            <p className={styles.heroLede}>
              The Republican front door onto We The Citizens. It asks you for nothing up front and shows you one thing: your own seats, the people holding them right now, what they actually voted for, and who could replace them.
            </p>
          ...
          <div className={styles.editorialGrid}>
            ...
            <div className={styles.editorialBody}>
              <p className={styles.dropcap}>
                Yes. This is the room where the political right does the work. We are building the replacement for TPUSA — a claim that exists on this door and on no other — and the job is getting political challengers into power to replace incumbents controlled by global elites.
              </p>
              <p>
              ...
              <p>
                Cross-party persuasion is expensive and slow. In-party accountability is cheap and fast, because you already agree with the party label and only have to be shown that this particular officeholder is not delivering on it. Holding your own side to its own stated standard is the highest-leverage act available to a voter.
              </p>
              <div className={styles.dateStamp}>{DOMAIN} · The Republican edition</div>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className={styles.wrap}>
          ...
          <div className={styles.planGrid}>
            ...
            <article className={styles.planCard}>
              ...
              <p>
                The leading challenger on your own side — a primary challenger when the incumbent is also a Republican — with
      ...
      <section className={clsx(styles.section, styles.bgPanel)} id="stands">
        <div className={styles.wrap}>
          <div className={clsx(styles.sectionHead, styles.sectionHeadSplit)}>
            ...
            <p className={styles.sectionLead}>
              Written by Republican voters, in Republican language, on this door and nowhere else. The .io stays neutral; everything partisan lives here.
            </p>
          </div>
        ...
        <div className={styles.wrap}>
          ...
          <div className={styles.programs}>
            <article className={styles.program}>
              ...
              <p>
                The Republican front door at {DOMAIN}. Written for Republicans, from
                marketing/messaging/republicans.md.
              </p>
              <div className={styles.pTag}>Republicans · {DOMAIN}</div>
            </article>
