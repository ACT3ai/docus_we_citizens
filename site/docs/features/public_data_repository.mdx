...
* **[Open Data](/open_data/overview)** — what is in the public record, and how to check a claim end to end.
* **[The sourcing rule](/open_data/the_sourcing_rule)** — why the official record or nothing.
* **[Naming the gaps](/evidence/naming_the_gaps)** — how missing evidence is published rather than papered over.
* **[Run your own instance](/repos/run_your_own_instance)** — stand up code and data yourself, and check it without our help.
* **[Propose a correction](/open_data/propose_a_correction)** — how to send a fix back when a record is wrong.
