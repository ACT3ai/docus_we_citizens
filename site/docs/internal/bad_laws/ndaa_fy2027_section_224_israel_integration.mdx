...
The framing of the [We The Citizens movement](/docs/the_movement/overview/) is direct: a law that violates the values of American citizens, advanced through Congress despite the underlying public opposition, is evidence that some force other than American voters is setting US policy.
