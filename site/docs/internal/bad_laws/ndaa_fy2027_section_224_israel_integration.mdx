...
The framing of the [We The Citizens movement](/the_movement/overview/) is direct: a law that violates the values of American citizens, advanced through Congress despite the underlying public opposition, is evidence that some force other than American voters is setting US policy.
...
See also: [Bad Laws Overview](/internal/bad-laws/overview) | [NDAA FY2012 — Indefinite Military Detention](/internal/bad-laws/ndaa-fy2012-indefinite-detention)
