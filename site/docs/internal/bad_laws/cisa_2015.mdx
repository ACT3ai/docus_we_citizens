...
**The intelligence community and Department of Homeland Security** drafted the core provisions of CISA and lobbied for years for its passage. The NSA in particular sought the corporate data pipeline CISA creates, as a supplement to the [foreign intelligence](/docs/foreign_intelligence/overview/) collection authorities that are legally more constrained.
