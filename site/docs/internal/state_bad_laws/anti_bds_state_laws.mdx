...
For each state, search the state legislature's [voting record](/voting_records/overview/) for the specific anti-BDS bill. In most states these bills passed with broad bipartisan support; a NO vote is relatively rare and notable.
...
See also: [State Bad Laws Overview](/internal/state-bad-laws/overview) | [Anti-Boycott Israel Laws (BDS)](/internal/anti-boycott-israel)
