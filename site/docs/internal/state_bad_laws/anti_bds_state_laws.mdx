...
For each state, search the state legislature's [voting record](/docs/voting_records/overview/) for the specific anti-BDS bill. In most states these bills passed with broad bipartisan support; a NO vote is relatively rare and notable.
