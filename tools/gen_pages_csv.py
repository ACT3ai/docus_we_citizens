...
EXTRA = {
 ...
 'rigged_economy_overview': ['the rigged layer', 'the rigged economy', 'rigged economy'],
 'rigged_economy_how_the_rigging_works': ['how the rigging works'],
 'rigged_economy_document_it_yourself': ['document it yourself'],
 'rigged_economy_captured_congress_is_the_blocker': ['captured congress is the blocker', 'a captured congress'],
